...
Let's test it on a simulated non-linear causal chain ($A \to B \to C$):
1. **A**: Independent noise
2. **B**: Depends on the **square** of A from 2 steps ago.
3. **C**: Depends on the **absolute value** of B from 1 step ago.
...
```{r plot_xi_matrix, fig.height = 6, fig.width = 7}
