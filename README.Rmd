...
<!-- badges: end -->
The xiacf package provides a robust framework for detecting complex non-linear and functional dependence in time series data. Traditional linear metrics, such as the standard Autocorrelation Function (ACF), often conflate stochastic noise with structural decay. This package overcomes these limitations by integrating **Chatterjee's rank correlation coefficient ($\xi$)** with high-performance C++ backend computations.
